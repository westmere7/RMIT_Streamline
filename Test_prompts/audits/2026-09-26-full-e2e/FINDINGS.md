...
### F-117 — Public bookings: an abuse guard is missing

Held back from this public repository until it is fixed; the owner has the full write-up.
...
| F-127 | Ticket numbering: a permission gap (held back until fixed) | — |
...
| F-165 | Portal passwords: an abuse guard is missing (held back until fixed) | — |
...
| F-180 | Automation runner: a caller check is missing (held back until fixed) | — |
