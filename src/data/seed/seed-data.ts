...
function buildBaseSeed(now: Date): { base: SeedBundle; lookups: SeedLookups } {
  ...
  const recent: Array<Omit<Activity, "id" | "workspaceId">> = [
    { boardId: SEED_BOARD_IDS.rmitinerary, itemId: itemId("rmitinerary", "RMITinerary High Achiever"), actorId: SEED_USER_IDS.danh, eventType: "ITEM_COLUMN_VALUE_UPDATED", metadata: { itemName: "RMITinerary High Achiever", columnName: "Status", columnType: "STATUS", from: "In Progress", to: "Done" }, createdAt: iso(subMinutes(now, 35)) },
    ...
    { boardId: SEED_BOARD_IDS.masterclass, itemId: itemId("masterclass", "Masterclass landing page hero"), actorId: SEED_USER_IDS.hil, eventType: "ITEM_COLUMN_VALUE_UPDATED", metadata: { itemName: "Masterclass landing page hero", columnName: "Status", columnType: "STATUS", from: "In Progress", to: "Stuck" }, createdAt: iso(subHours(now, 5)) },
    ...
    { boardId: SEED_BOARD_IDS.sem1, itemId: itemId("sem1", "Paid social – phase 1"), actorId: SEED_USER_IDS.jun, eventType: "ITEM_COLUMN_VALUE_UPDATED", metadata: { itemName: "Paid social – phase 1", columnName: "Status", columnType: "STATUS", from: "In Progress", to: "Done" }, createdAt: iso(subDays(now, 1)) },
    { boardId: SEED_BOARD_IDS.dooh, itemId: itemId("dooh", "Shopping centre network – 6 sites"), actorId: SEED_USER_IDS.duc, eventType: "ITEM_COLUMN_VALUE_UPDATED", metadata: { itemName: "Shopping centre network – 6 sites", columnName: "Status", columnType: "STATUS", from: "In Progress", to: "Stuck" }, createdAt: iso(subDays(now, 1)) },
  ...
  const notifications: Notification[] = ([
    ...
    { id: sid("notification"), userId: SEED_USER_IDS.danh, type: "STATUS_CHANGED", title: "Masterclass landing page hero is now Stuck", body: "Hil changed the status from In Progress", entityType: "ITEM", entityId: itemId("masterclass", "Masterclass landing page hero"), boardId: SEED_BOARD_IDS.masterclass, actorId: SEED_USER_IDS.hil, readAt: iso(subHours(now, 4)), createdAt: iso(subHours(now, 5)) },
    ...
    { id: sid("notification"), userId: SEED_USER_IDS.emily, type: "STATUS_CHANGED", title: "RMITinerary High Achiever is now Done", body: "Danh changed the status from In Progress", entityType: "ITEM", entityId: itemId("rmitinerary", "RMITinerary High Achiever"), boardId: SEED_BOARD_IDS.rmitinerary, actorId: SEED_USER_IDS.danh, readAt: null, createdAt: iso(subMinutes(now, 35)) },
    ...
    { id: sid("notification"), userId: SEED_USER_IDS.tom, type: "STATUS_CHANGED", title: "Masterclass registration form is now Stuck", body: "Ravi changed the status from In Progress", entityType: "ITEM", entityId: itemId("website", "Masterclass registration form"), boardId: SEED_BOARD_IDS.website, actorId: SEED_USER_IDS.ravi, readAt: null, createdAt: iso(subHours(now, 4)) },
