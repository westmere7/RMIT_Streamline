...
export const BOARD_HISTORY: HistoryBoardSpec[] = [
  {
    ...
    assets: [
      { name: "Instagram tile", type: "Static Designs", notes: "1080×1080", qty: [2, 6] },
      { name: "Story", type: "Static Designs", notes: "1080×1920, safe zones for UI", qty: [2, 4] },
      { name: "MREC banner", type: "Display ads", notes: "300×250, under 150 KB", qty: [1, 3] },
      { name: "Leaderboard", type: "Display ads", notes: "728×90 + 320×50", qty: [1, 2] },
      { name: "30s master", type: "Videos (Short form)", notes: "16:9, 4K ProRes + H.264", qty: null },
      { name: "Full-page press ad", type: "Print assets", notes: "260×380 mm, CMYK, 5 mm bleed", qty: [1, 2] },
      { name: "Landing page hero", type: "Website Copy", notes: "1920×600, WebP", qty: null },
    ],
    descriptions: [
  ...
  },
  {
    ...
    assets: [
      { name: "Instagram tile", type: "Static Designs", notes: "1080×1080", qty: [1, 4] },
      { name: "Story", type: "Static Designs", notes: "1080×1920", qty: [1, 3] },
      { name: "LinkedIn banner", type: "Display ads", notes: "1584×396", qty: null },
      { name: "Email header", type: "Display ads", notes: "600×200", qty: [1, 2] },
      { name: "A3 poster", type: "Print assets", notes: "297×420 mm, CMYK", qty: [1, 2] },
      { name: "Pull-up banner", type: "Event Copy", notes: "850×2000 mm", qty: [1, 2] },
    ],
  ...
  },
  {
    ...
    assets: [
      { name: "Spread (print)", type: "Print assets", notes: "A4 4pp, CMYK, 3 mm bleed", qty: [1, 2] },
      { name: "Spread (digital)", type: "Display ads", notes: "PDF, tagged", qty: null },
      { name: "Illustration", type: "Static Designs", notes: "Vector, brand palette", qty: [1, 4] },
      { name: "Map", type: "Print assets", notes: "A3 fold-out", qty: null },
      { name: "Web tile", type: "Website Copy", notes: "1200×630", qty: [1, 2] },
    ],
  ...
  },
  {
    ...
    assets: [
      { name: "Portrait loop", type: "GIF / Motion", notes: "1080×1920 @ 10 s, MP4 H.264", qty: [1, 3] },
      { name: "Landscape loop", type: "GIF / Motion", notes: "1920×1080 @ 8 s", qty: [1, 2] },
      { name: "Static slide", type: "Display ads", notes: "1920×1080 JPG", qty: [1, 4] },
      { name: "Large format", type: "GIF / Motion", notes: "2160×3840 @ 10 s", qty: null },
    ],
  ...
  },
  {
    ...
    assets: [
      { name: "A3 poster", type: "Print assets", notes: "297×420 mm, CMYK", qty: [1, 6] },
      { name: "A4 flyer", type: "Print assets", notes: "Double-sided, 150 gsm", qty: [50, 500] },
      { name: "Pull-up banner", type: "Event Copy", notes: "850×2000 mm", qty: [1, 3] },
      { name: "Social tile", type: "Static Designs", notes: "1080×1080", qty: [1, 4] },
      { name: "Email header", type: "Display ads", notes: "600×200", qty: null },
      { name: "Slide template", type: "Display ads", notes: "16:9 PowerPoint", qty: null },
    ],
  ...
  },
  {
    ...
    assets: [
      { name: "Feed tile", type: "Static Designs", notes: "1080×1080", qty: [1, 3] },
      { name: "Story", type: "Static Designs", notes: "1080×1920", qty: [1, 3] },
      { name: "Reel", type: "Videos (Short form)", notes: "9:16, under 30 s, captions", qty: null },
      { name: "Web article image", type: "Website Copy", notes: "1200×630", qty: null },
    ],
  ...
  },
  {
    ...
    assets: [
      { name: "A-frame insert", type: "Print assets", notes: "A1, corflute", qty: [4, 40] },
      { name: "Feather banner", type: "Event Copy", notes: "600×2400 mm, double-sided", qty: [2, 24] },
      { name: "Building banner", type: "Print assets", notes: "3000×9000 mm mesh", qty: [1, 3] },
      { name: "Stage slide", type: "Display ads", notes: "1920×1080", qty: [4, 30] },
      { name: "Programme booklet", type: "Print assets", notes: "A5 32pp, saddle-stitched", qty: [1000, 3000] },
      { name: "Social tile", type: "Static Designs", notes: "1080×1080", qty: [1, 6] },
    ],
  ...
  },
  {
    ...
    assets: [
      { name: "Master", type: "Videos (Short form)", notes: "16:9, 4K ProRes 422", qty: null },
      { name: "Social cutdown", type: "Videos (Short form)", notes: "9:16 and 1:1, captions burnt in", qty: [1, 4] },
      { name: "Caption file", type: "Campaign Copy", notes: "SRT, EN + VI", qty: [1, 2] },
      { name: "Thumbnail", type: "Display ads", notes: "1280×720", qty: [1, 3] },
      { name: "Lower-third pack", type: "GIF / Motion", notes: "After Effects template", qty: null },
    ],
  ...
  },
  {
    ...
    assets: [
      { name: "Guideline section", type: "Static Designs", notes: "InDesign, A4 landscape", qty: null },
      { name: "Logo files", type: "Static Designs", notes: "SVG, EPS, PNG @2x", qty: [2, 12] },
      { name: "Template", type: "Display ads", notes: "PowerPoint / Word", qty: [1, 3] },
      { name: "Sample artwork", type: "Print assets", notes: "A4, for the brand council", qty: [1, 4] },
    ],
  ...
  },
  {
    ...
    assets: [
      { name: "Figma frame", type: "Website Copy", notes: "Desktop + mobile", qty: [2, 6] },
      { name: "Hero image", type: "Website Copy", notes: "1920×600 WebP", qty: [1, 3] },
      { name: "Icon", type: "Static Designs", notes: "SVG, 24 px grid", qty: [1, 12] },
    ],
  ...
  },
  {
    ...
    assets: [
      { name: "Feed tile", type: "Static Designs", notes: "1080×1080", qty: [1, 6] },
      { name: "Story", type: "Static Designs", notes: "1080×1920", qty: [1, 4] },
      { name: "Reel", type: "Videos (Short form)", notes: "9:16, 15–30 s", qty: null },
      { name: "Carousel card", type: "Static Designs", notes: "1080×1350", qty: [3, 10] },
    ],
