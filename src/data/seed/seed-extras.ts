...
const FRESH_ITEMS: ExtraItemSpec[] = [
  ...
  // Work at every stage, so each status on the board is worn by something —
  // "In Review" most of all, since a review queue is where most boards jam.
  { board: "sem1", group: "Review", name: "Sem 1 hero film – client cut", owner: ["duc"], status: "review", priority: "high", due: 3, timeline: [-4, 3], tags: ["Video"], createdBy: "joanne", createdDaysAgo: 6, description: "Second cut with the revised end frame. With the faculty marketing leads until Thursday." },
  { board: "sem1", group: "Production", name: "Lecture theatre digital screens", owner: ["tuyet"], status: "working", priority: "medium", due: 6, timeline: [-1, 6], tags: ["Social"], createdBy: "emily", createdDaysAgo: 4 },
  { board: "sem1", group: "Completed", name: "Orientation week recap post", owner: ["emily"], status: "done", priority: "low", due: -3, tags: ["Social"], createdBy: "emily", createdDaysAgo: 12 },
  { board: "masterclass", group: "Internal Review", name: "Masterclass highlight reel – 60s", owner: ["duc"], status: "review", priority: "high", due: 2, text: { format: "1920x1080, 60s" }, tags: ["Global"], createdBy: "emily", createdDaysAgo: 5 },
  { board: "masterclass", group: "Briefing", name: "Masterclass speaker pack v2", owner: ["linh"], status: "not_started", priority: "medium", due: 9, text: { format: "A4 PDF" }, createdBy: "emily", createdDaysAgo: 1 },
  { board: "rmitinerary", group: "Stakeholder Review", name: "RMITinerary cover concepts", owner: ["tuyet"], status: "review", priority: "high", due: 1, timeline: [-5, 1], text: { notes: "Three routes, all using the new wordmark lockup." }, createdBy: "danh", createdDaysAgo: 7 },
  { board: "rmitinerary", group: "Production", name: "Print-ready PDF export checklist", owner: ["hil"], status: "waiting", priority: "medium", due: 4, text: { notes: "Waiting on the printer's ink limit for the uncoated stock." }, createdBy: "danh", createdDaysAgo: 3 },
  { board: "dooh", group: "Internal Review", name: "Airport lounge screen – departures", owner: ["duc"], status: "review", priority: "medium", due: 3, text: { format: "1920x1080, 15s loop" }, createdBy: "thao", createdDaysAgo: 5 },
  { board: "dooh", group: "This Fortnight", name: "Tram superstop panels – city", owner: ["tuyet"], status: "not_started", priority: "low", due: 12, text: { format: "1520x2160 mm" }, createdBy: "thao", createdDaysAgo: 2 },
  { board: "requests", group: "In Progress", name: "Alumni awards invitation suite", requester: ["grace"], owner: ["tuyet"], status: "review", priority: "high", due: 2, number: { estimate: 6 }, createdBy: "grace", createdDaysAgo: 6 },
  { board: "requests", group: "Triaged", name: "Faculty newsletter template refresh", requester: ["jane"], owner: ["hil"], status: "waiting", priority: "medium", due: 7, number: { estimate: 4 }, createdBy: "jane", createdDaysAgo: 4 },
  { board: "openday", group: "Review", name: "Wayfinding map – Brunswick", owner: ["danh"], status: "review", priority: "critical", due: 1, timeline: [-3, 1], tags: ["Brunswick"], number: { budget: 1200 }, createdBy: "priya", createdDaysAgo: 6 },
  { board: "openday", group: "Production", name: "Info tent banner set", owner: ["thao"], status: "stuck", priority: "high", due: 0, timeline: [-4, 0], tags: ["City"], number: { budget: 800 }, createdBy: "priya", createdDaysAgo: 8, description: "Held up until the venue confirms the rigging dimensions; the banners cannot be sized without them." },
  { board: "video", group: "Client Review", name: "Scholarship TVC – 15s cutdown", owner: ["duc"], status: "review", priority: "high", due: 2, timeline: [-6, 2], text: { format: "1920x1080, 15s" }, checkbox: { approved: false }, createdBy: "joanne", createdDaysAgo: 5 },
  { board: "video", group: "Post-production", name: "Research showcase interviews – grade", owner: ["minh"], status: "working", priority: "medium", due: 5, timeline: [-2, 5], text: { format: "4K ProRes" }, checkbox: { approved: false }, createdBy: "joanne", createdDaysAgo: 3 },
  { board: "brand", group: "Internal Review", name: "Brand portal – icon set v2", owner: ["sarah"], status: "review", priority: "medium", due: 4, text: { notes: "Second pass after the accessibility review; 24 icons at three weights." }, createdBy: "sarah", createdDaysAgo: 5 },
  { board: "brand", group: "Design", name: "Sub-brand lockups – research institutes", owner: ["danh"], status: "working", priority: "high", due: 6, createdBy: "sarah", createdDaysAgo: 4 },
  { board: "website", group: "QA", name: "Course finder filters", owner: ["ravi"], status: "review", priority: "high", due: 3, number: { points: 5 }, createdBy: "tom", createdDaysAgo: 6 },
  { board: "website", group: "This Sprint", name: "Accessibility fixes – contrast pass", owner: ["hil"], status: "working", priority: "medium", due: 8, number: { points: 3 }, createdBy: "tom", createdDaysAgo: 2 },
  { board: "website", group: "In Progress", name: "Payment gateway sandbox", owner: ["ravi"], status: "stuck", priority: "critical", due: -1, number: { points: 8 }, createdBy: "tom", createdDaysAgo: 9, description: "Sandbox credentials from the finance system have not come through, so nothing can be tested end to end." },
  { board: "social", group: "Scheduled", name: "Graduation week reel", owner: ["chloe"], status: "review", priority: "medium", due: 2, tags: ["Instagram"], checkbox: { approved: false }, createdBy: "chloe", createdDaysAgo: 4 },
  { board: "social", group: "Ideas", name: "Study abroad Q&A carousel", owner: ["jane"], status: "not_started", priority: "low", due: 14, tags: ["Instagram", "Facebook"], createdBy: "chloe", createdDaysAgo: 1 },
  { board: "alwayson", group: "Drafting", name: "Student wellbeing blog series", owner: ["jane"], status: "working", priority: "medium", due: 5, createdBy: "chloe", createdDaysAgo: 3 },
  { board: "alwayson", group: "This Week", name: "Campus food guide", owner: ["chloe"], status: "done", priority: "low", due: -1, createdBy: "jane", createdDaysAgo: 10 },
];
...
export function buildSeedExtras(ctx: SeedExtrasContext): SeedBundle {
  ...
  notify({ userId: users.danh, type: "STATUS_CHANGED", title: "Volunteer briefing pack is now In Progress", body: "Thao changed the status from Not Started", entityType: "ITEM", entityId: freshItemByName.get("openday:Volunteer briefing pack")!.id, boardId: boards.openday, actorId: users.thao, readAt: iso(subHours(now, 20)), createdAt: iso(subHours(now, 21)) });
  ...
  notify({ userId: users.admin, type: "STATUS_CHANGED", title: "Library orientation floor decals is now Done", body: "Danh changed the status from In Progress", entityType: "ITEM", entityId: bookingItemByTitle.get("Library orientation floor decals")!.id, boardId: allocationBoardId, actorId: users.danh, readAt: iso(subHours(now, 58)), createdAt: iso(subHours(now, 61)) });
