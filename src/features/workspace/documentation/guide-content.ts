...
export const GUIDE_ARTICLES: GuideArticle[] = [
  ...
  },
  {
    ...
    sections: [
      { title: "Settings directory", table: { headers: ["Section", "Purpose"], rows: [
        ...
        ["Appearance", "Your theme, sidebar preferences, and What's new after an update, on this device."],
  ...
  },
  {
    ...
    sections: [
      { title: "Find your way around", paragraphs: ["On a phone, five tabs sit along the bottom: Home, My Work, Browse, Inbox, and More. Browse lists your teams, boards, and trackers, and makes new boards; More holds the dashboard, automations, Portal and Booking, messages, members, settings, your profile, and the theme. Search is in the top bar and opens full screen."] },
      { title: "Work on a board", steps: [
        "Open a board from Browse or My Work. Tasks show as cards; switch to the grid for the table.",
        "Tap a card's status or date to change it from a sheet. Today and Tomorrow are your own days.",
        "Use New item to add a task, and Select to act on several.",
        "Kanban shows one lane at a time; use Move to another lane to change a card's lane.",
        "Tap a task's name to open it full screen, with its updates, deliverables, and activity.",
      ] },
      { title: "My Work and settings", paragraphs: ["My Work has a search box and a Filters sheet with the same filters as on a desktop. Settings opens as a list: tap a section to open it, and Settings to go back."] },
      { title: "Add it to your home screen", paragraphs: ["From the browser's menu, add Streamline to your home screen (on an iPhone: Share, then Add to Home Screen). It then opens full screen, like an app."] },
      { title: "Appearance, notifications, and the connection", paragraphs: ["Choose a theme from More. Portal visitors have their own theme switch. Browser notifications need an open Streamline tab, and on an iPhone or iPad, Streamline on the Home Screen. When the connection drops, a bar says so; changes save when it returns."] },
    ],
