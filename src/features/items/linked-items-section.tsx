...
function SyncSummary({
  ...
  // Assets are always in the list: they are shared by the link rather than
  // copied, and there is no switching that off.
  const synced = ["assets", ...(nameOn ? ["name, description"] : []), ...on.map(label)];
