...
export const SYSTEM_BOARD = { name: "Task Allocation", description: "Every task booked through the form lands here until a manager places it with a team.", color: "red", icon: "inbox" } as const;
